...
static inline uint32_t XLogMd5F(uint32_t x, uint32_t y, uint32_t z) { return (x & y) | (~x & z); }
static inline uint32_t XLogMd5G(uint32_t x, uint32_t y, uint32_t z) { return (x & z) | (y & ~z); }
static inline uint32_t XLogMd5H(uint32_t x, uint32_t y, uint32_t z) { return x ^ y ^ z; }
static inline uint32_t XLogMd5I(uint32_t x, uint32_t y, uint32_t z) { return y ^ (x | ~z); }

static inline void XLogMd5Step(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint32_t s, uint32_t ac, uint32_t (*func)(uint32_t, uint32_t, uint32_t))
{
	a += func(b, c, d) + x + ac;
	a = XLogRotl32(a, s);
	a += b;
...
static inline void XLogMd5Transform(uint32_t state[4], const unsigned char block[64])
{
	...
	XLogMd5Step(a, b, c, d, x[0], 7, 0xd76aa478, XLogMd5F); XLogMd5Step(d, a, b, c, x[1], 12, 0xe8c7b756, XLogMd5F);
	XLogMd5Step(c, d, a, b, x[2], 17, 0x242070db, XLogMd5F); XLogMd5Step(b, c, d, a, x[3], 22, 0xc1bdceee, XLogMd5F);
	XLogMd5Step(a, b, c, d, x[4], 7, 0xf57c0faf, XLogMd5F); XLogMd5Step(d, a, b, c, x[5], 12, 0x4787c62a, XLogMd5F);
	XLogMd5Step(c, d, a, b, x[6], 17, 0xa8304613, XLogMd5F); XLogMd5Step(b, c, d, a, x[7], 22, 0xfd469501, XLogMd5F);
	XLogMd5Step(a, b, c, d, x[8], 7, 0x698098d8, XLogMd5F); XLogMd5Step(d, a, b, c, x[9], 12, 0x8b44f7af, XLogMd5F);
	XLogMd5Step(c, d, a, b, x[10], 17, 0xffff5bb1, XLogMd5F); XLogMd5Step(b, c, d, a, x[11], 22, 0x895cd7be, XLogMd5F);
	XLogMd5Step(a, b, c, d, x[12], 7, 0x6b901122, XLogMd5F); XLogMd5Step(d, a, b, c, x[13], 12, 0xfd987193, XLogMd5F);
	XLogMd5Step(c, d, a, b, x[14], 17, 0xa679438e, XLogMd5F); XLogMd5Step(b, c, d, a, x[15], 22, 0x49b40821, XLogMd5F);

	XLogMd5Step(a, b, c, d, x[1], 5, 0xf61e2562, XLogMd5G); XLogMd5Step(d, a, b, c, x[6], 9, 0xc040b340, XLogMd5G);
	XLogMd5Step(c, d, a, b, x[11], 14, 0x265e5a51, XLogMd5G); XLogMd5Step(b, c, d, a, x[0], 20, 0xe9b6c7aa, XLogMd5G);
	XLogMd5Step(a, b, c, d, x[5], 5, 0xd62f105d, XLogMd5G); XLogMd5Step(d, a, b, c, x[10], 9, 0x02441453, XLogMd5G);
	XLogMd5Step(c, d, a, b, x[15], 14, 0xd8a1e681, XLogMd5G); XLogMd5Step(b, c, d, a, x[4], 20, 0xe7d3fbc8, XLogMd5G);
	XLogMd5Step(a, b, c, d, x[9], 5, 0x21e1cde6, XLogMd5G); XLogMd5Step(d, a, b, c, x[14], 9, 0xc33707d6, XLogMd5G);
	XLogMd5Step(c, d, a, b, x[3], 14, 0xf4d50d87, XLogMd5G); XLogMd5Step(b, c, d, a, x[8], 20, 0x455a14ed, XLogMd5G);
	XLogMd5Step(a, b, c, d, x[13], 5, 0xa9e3e905, XLogMd5G); XLogMd5Step(d, a, b, c, x[2], 9, 0xfcefa3f8, XLogMd5G);
	XLogMd5Step(c, d, a, b, x[7], 14, 0x676f02d9, XLogMd5G); XLogMd5Step(b, c, d, a, x[12], 20, 0x8d2a4c8a, XLogMd5G);

	XLogMd5Step(a, b, c, d, x[5], 4, 0xfffa3942, XLogMd5H); XLogMd5Step(d, a, b, c, x[8], 11, 0x8771f681, XLogMd5H);
	XLogMd5Step(c, d, a, b, x[11], 16, 0x6d9d6122, XLogMd5H); XLogMd5Step(b, c, d, a, x[14], 23, 0xfde5380c, XLogMd5H);
	XLogMd5Step(a, b, c, d, x[1], 4, 0xa4beea44, XLogMd5H); XLogMd5Step(d, a, b, c, x[4], 11, 0x4bdecfa9, XLogMd5H);
	XLogMd5Step(c, d, a, b, x[7], 16, 0xf6bb4b60, XLogMd5H); XLogMd5Step(b, c, d, a, x[10], 23, 0xbebfbc70, XLogMd5H);
	XLogMd5Step(a, b, c, d, x[13], 4, 0x289b7ec6, XLogMd5H); XLogMd5Step(d, a, b, c, x[0], 11, 0xeaa127fa, XLogMd5H);
	XLogMd5Step(c, d, a, b, x[3], 16, 0xd4ef3085, XLogMd5H); XLogMd5Step(b, c, d, a, x[6], 23, 0x04881d05, XLogMd5H);
	XLogMd5Step(a, b, c, d, x[9], 4, 0xd9d4d039, XLogMd5H); XLogMd5Step(d, a, b, c, x[12], 11, 0xe6db99e5, XLogMd5H);
	XLogMd5Step(c, d, a, b, x[15], 16, 0x1fa27cf8, XLogMd5H); XLogMd5Step(b, c, d, a, x[2], 23, 0xc4ac5665, XLogMd5H);

	XLogMd5Step(a, b, c, d, x[0], 6, 0xf4292244, XLogMd5I); XLogMd5Step(d, a, b, c, x[7], 10, 0x432aff97, XLogMd5I);
	XLogMd5Step(c, d, a, b, x[14], 15, 0xab9423a7, XLogMd5I); XLogMd5Step(b, c, d, a, x[5], 21, 0xfc93a039, XLogMd5I);
	XLogMd5Step(a, b, c, d, x[12], 6, 0x655b59c3, XLogMd5I); XLogMd5Step(d, a, b, c, x[3], 10, 0x8f0ccc92, XLogMd5I);
	XLogMd5Step(c, d, a, b, x[10], 15, 0xffeff47d, XLogMd5I); XLogMd5Step(b, c, d, a, x[1], 21, 0x85845dd1, XLogMd5I);
	XLogMd5Step(a, b, c, d, x[8], 6, 0x6fa87e4f, XLogMd5I); XLogMd5Step(d, a, b, c, x[15], 10, 0xfe2ce6e0, XLogMd5I);
	XLogMd5Step(c, d, a, b, x[6], 15, 0xa3014314, XLogMd5I); XLogMd5Step(b, c, d, a, x[13], 21, 0x4e0811a1, XLogMd5I);
	XLogMd5Step(a, b, c, d, x[4], 6, 0xf7537e82, XLogMd5I); XLogMd5Step(d, a, b, c, x[11], 10, 0xbd3af235, XLogMd5I);
	XLogMd5Step(c, d, a, b, x[2], 15, 0x2ad7d2bb, XLogMd5I); XLogMd5Step(b, c, d, a, x[9], 21, 0xeb86d391, XLogMd5I);
...
static inline uint32_t XLogSm3P0(uint32_t x) { return x ^ XLogRotl32(x, 9) ^ XLogRotl32(x, 17); }
static inline uint32_t XLogSm3P1(uint32_t x) { return x ^ XLogRotl32(x, 15) ^ XLogRotl32(x, 23); }
static inline uint32_t XLogSm3FF0(uint32_t x, uint32_t y, uint32_t z) { return x ^ y ^ z; }
static inline uint32_t XLogSm3FF1(uint32_t x, uint32_t y, uint32_t z) { return (x & y) | (x & z) | (y & z); }
static inline uint32_t XLogSm3GG0(uint32_t x, uint32_t y, uint32_t z) { return x ^ y ^ z; }
static inline uint32_t XLogSm3GG1(uint32_t x, uint32_t y, uint32_t z) { return (x & y) | (~x & z); }
...
static inline void XLogSm3Process(XLogSm3Context *ctx, const unsigned char data[64])
{
	...
	for (int j = 0; j < 16; ++j) w[j] = XLogGetUint32Be(data, j * 4);
	for (int j = 16; j < 68; ++j)
	{
...
static inline void XLogSm3Update(XLogSm3Context *ctx, const unsigned char *input, int ilen)
{
	...
	if (ctx->total[0] < static_cast<uint32_t>(ilen)) ctx->total[1]++;
	if (left && ilen >= fill)
	{
...
static inline void XLogSm3Final(XLogSm3Context *ctx, unsigned char output[32])
{
	...
	for (int i = 0; i < 8; ++i) XLogPutUint32Be(ctx->state[i], output, i * 4);
}
...
static inline uint32_t XLogSms4ByteSub(uint32_t value)
{
	...
	return (static_cast<uint32_t>(sbox[(value >> 24) & 0xFF]) << 24) ^
		   ...
		   (static_cast<uint32_t>(sbox[(value >> 8) & 0xFF]) << 8) ^
		   static_cast<uint32_t>(sbox[value & 0xFF]);
}

static inline uint32_t XLogSms4L1(uint32_t b) { return b ^ XLogRotl32(b, 2) ^ XLogRotl32(b, 10) ^ XLogRotl32(b, 18) ^ XLogRotl32(b, 24); }
static inline uint32_t XLogSms4L2(uint32_t b) { return b ^ XLogRotl32(b, 13) ^ XLogRotl32(b, 23); }
static inline uint32_t XLogSms4SwapEndian(uint32_t x) { x = XLogRotl32(x, 16); return ((x & 0x00FF00FF) << 8) ^ ((x & 0xFF00FF00) >> 8); }
...
static inline void XLogSms4KeyExt(const unsigned char *key, uint32_t rk[32], bool decrypt)
{
	...
	{
		uint32_t mid = XLogSms4ByteSub(x1 ^ x2 ^ x3 ^ ck[r]); rk[r] = x0 ^= XLogSms4L2(mid);
		mid = XLogSms4ByteSub(x2 ^ x3 ^ x0 ^ ck[r + 1]); rk[r + 1] = x1 ^= XLogSms4L2(mid);
		mid = XLogSms4ByteSub(x3 ^ x0 ^ x1 ^ ck[r + 2]); rk[r + 2] = x2 ^= XLogSms4L2(mid);
		mid = XLogSms4ByteSub(x0 ^ x1 ^ x2 ^ ck[r + 3]); rk[r + 3] = x3 ^= XLogSms4L2(mid);
	}
	if (decrypt)
	{
		for (int r = 0; r < 16; ++r) std::swap(rk[r], rk[31 - r]);
	}
}
...
static inline void XLogSms4CryptBlock(const unsigned char *input, unsigned char *output, const uint32_t rk[32])
{
	...
	for (uint32_t r = 0; r < 32; r += 4)
	{
		uint32_t mid = XLogSms4ByteSub(x1 ^ x2 ^ x3 ^ rk[r]); x0 ^= XLogSms4L1(mid);
		mid = XLogSms4ByteSub(x2 ^ x3 ^ x0 ^ rk[r + 1]); x1 ^= XLogSms4L1(mid);
		mid = XLogSms4ByteSub(x3 ^ x0 ^ x1 ^ rk[r + 2]); x2 ^= XLogSms4L1(mid);
		mid = XLogSms4ByteSub(x0 ^ x1 ^ x2 ^ rk[r + 3]); x3 ^= XLogSms4L1(mid);
	}
	uint32_t out0 = XLogSms4SwapEndian(x3), out1 = XLogSms4SwapEndian(x2), out2 = XLogSms4SwapEndian(x1), out3 = XLogSms4SwapEndian(x0);
	memcpy(output, &out0, 4); memcpy(output + 4, &out1, 4); memcpy(output + 8, &out2, 4); memcpy(output + 12, &out3, 4);
}

static inline bool XLogSm4EncryptEcbPkcs7(const unsigned char *key, const unsigned char *plaintext, size_t plaintextLen, std::vector<unsigned char> &ciphertext)
{
...
static inline bool XLogMakeEnDataKey(const unsigned char *pwd, size_t pwdLen, const unsigned char *random16, unsigned char key[16])
{
	...
	for (size_t i = 0; i < sizeof(dzStrDigest); ++i) dzStrDigestNot[i] = static_cast<unsigned char>(~dzStrDigest[i]);
	XLogMd5(dzStrDigestNot, sizeof(dzStrDigestNot), md5Digest);
	for (size_t i = 0; i < sizeof(md5Digest); ++i) md5DigestNot[i] = static_cast<unsigned char>(~md5Digest[i]);
	...
	for (size_t i = 0; i < 16; ++i) key[i] = static_cast<unsigned char>(eKey[i] ^ random16[i]);
	return true;
}
...
class XLogger
{
  public:
	...
	{
		static const unsigned char kYKey[] = {
			0x30, 0x82, 0x0a, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
...
#define XLOG_TRACE(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::trace, __VA_ARGS__); } while(0)
#define XLOG_DEBUG(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::debug, __VA_ARGS__); } while(0)
#define XLOG_INFO(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::info, __VA_ARGS__); } while(0)
#define XLOG_WARN(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::warn, __VA_ARGS__); } while(0)
#define XLOG_ERROR(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::err, __VA_ARGS__); } while(0)
#define XLOG_CRITICAL(...) do { if (!XLogger::getInstance()->getLogger()) break; SPDLOG_LOGGER_CALL(XLogger::getInstance()->getLogger().get(), spdlog::level::critical, __VA_ARGS__); } while(0)
